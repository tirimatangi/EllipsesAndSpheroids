%% This test demonstrates intersections of 4 spheroids
...
otherFocalPoints(:,4) = [0; -14; -4] + sharedFocalPoint;
...
plotSpheroids(sharedFocalPoint, otherFocalPoints, diameters, intersections, "4 spheroids, Case 1");
...
otherFocalPoints(:,4) = [-7; -14; -4] + sharedFocalPoint;
...
% Calculate spheroid coordinates and plot the coordinates and the intersection points.
plotSpheroids(sharedFocalPoint, otherFocalPoints, diameters, intersections, "4 spheroids, Case 2");
...
otherFocalPoints(:,4) = [-7; -4; -7-4] + sharedFocalPoint;
...
% Calculate spheroid coordinates and plot the coordinates and the intersection points.
plotSpheroids(sharedFocalPoint, otherFocalPoints, diameters, intersections, "4 spheroids, Case 3");
...
otherFocalPoints(:,4) = [-8; -3; 4] + sharedFocalPoint;
...
% Calculate spheroid coordinates and plot the coordinates and the intersection points.
plotSpheroids(sharedFocalPoint, otherFocalPoints, diameters, intersections, "4 spheroids, Case 4");
